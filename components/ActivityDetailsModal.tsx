...
import { 
  X, ShieldAlert, Sun, 
  Briefcase, Info, ChevronRight, AlertCircle, Sparkles
} from 'lucide-react';
          ...
          <div className="p-8 pt-2 space-y-8">
            {!hasData && !isAdmin ? (
               <div className="py-20 flex flex-col items-center justify-center text-center px-10">
                 ...
                 <p className="text-slate-400 font-bold text-sm leading-relaxed italic">Esta actividad aún no tiene detalles registrados.</p>
               </div>
            ) : (
              <>
                <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="text-slate-600 text-sm font-medium leading-relaxed bg-slate-50 p-6 rounded-[2rem] border border-slate-100 italic relative group">
                    <EditableText 
                      isAdmin={!!isAdmin} 
                      text={activity.extendedDescription || 'No hay descripción detallada.'} 
                      multiline
                ...
                <div className="grid sm:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
                  <section>
                    ...
                    <ul className="space-y-2">
                      {isAdmin ? (
                        ...
                        )) || <li className="text-[10px] text-slate-300 italic">Sin datos</li>
                      )}
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="bg-emerald-50/50 p-5 rounded-[2rem] border border-emerald-100 text-emerald-800 text-[11px] font-bold leading-relaxed">
                      <EditableText 
                        isAdmin={!!isAdmin} 
                        text={activity.bestTime || 'No especificado.'} 
                ...
                <section className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
                  ...
                  <div className="grid gap-3">
                    {isAdmin ? (
                      ...
                      )) || <div className="text-[10px] text-slate-300 italic">Sin consejos</div>
                    )}
                  </div>
                </section>
              </>
